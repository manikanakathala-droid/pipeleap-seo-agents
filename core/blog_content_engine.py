...
class BlogContentEngine:
    ...
    def _blog_how_to(
        ...
        sections = [
            ...
            "",
            "```text",
            "Step 1 → Define intake trigger (intent signal / list / form fill / enrichment threshold)",
            "Step 2 → Add enrichment nodes with provider chain + fallback logic",
            "Step 3 → Set qualification gate — contacts below ICP score go to review queue",
